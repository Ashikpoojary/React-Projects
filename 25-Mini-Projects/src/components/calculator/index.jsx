...
export const Calculator = () => {
    ...
    // The eval() function in JavaScript evaluates or executes a string of JavaScript code. 
    // It can be used to evaluate expressions or execute statements dynamically.
